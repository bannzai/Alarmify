...
| 層 | 内容 | 狙い |
| --- | --- | --- |
| 無料 | API トークン 1 つ・月 50 回までのアラーム登録・アプリ内からのテストアラーム | 「Webhook で本物のアラームが鳴る」体験を完全に試せる線 |
| Pro (年 $14.99 目安。月額は $1.99〜2.99 目安) | 複数トークン (サービス別)・月 1000 回までの登録・アラーム履歴・複数端末への配送 | サーバー側で価値を出す機能を Pro に寄せ、サブスクに値する理由を明確にする |
