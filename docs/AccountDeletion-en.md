...
These are the steps to delete your Alarmify account (provider: bannzai) and the data stored on the Provider's servers.

## Deleting from Within the App

1. Open Alarmify and open "Settings"
...
- A record used to confirm that the deletion has completed (the account identifier only; it contains no other data) is erased automatically within a maximum of 3 hours after deletion
